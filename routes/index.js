...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/schools/index', // where do you want the client to go after you login
    failureRedirect : '/schools/index' // where do you want the client to go if login fails
  }
));
